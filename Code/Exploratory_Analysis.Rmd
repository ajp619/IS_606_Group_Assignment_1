...
This is good. Through simulation we can see that `r stock.range[which(results == max(results))]`  is the right number of ham sandwiches to stock. 
...
Bayesian models for veggie sandwiches for the whole time period.

```{r}
bayes_model <- MCMCpoisson(demand.veggie ~ date, data=sales,
                           burnin=1000, mcm=10000, thin=1, tune=0.7,
